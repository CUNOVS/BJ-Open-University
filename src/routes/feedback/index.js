...
class FeedBack extends Component {
  ...
  render () {
    const { name = '反馈', courseid, id } = this.props.location.query,
      { data: { intro, completedcount, itemscount, itemsdata, anonymous, coursemodule, completionsubmit }, selectIndex = 0 } = this.props.feedback;
    return (
      <div >
        ...
        <div className={styles[`${PrefixCls}-outer`]} >
          ...
          >
            <div >
              <List >
                ...
                >
                  已提交的答案</Item >
                {/*{anonymous !== 1 ?*/}
                {/*<Item arrow="horizontal" >显示未答复者</Item >*/}
                {/*:*/}
                {/*null*/}
                {/*}*/}
                <Item extra={itemscount} >题目</Item >
              </List >
            ...
            <div >
              <List >
                <Item extra={completedcount} >已提交的答案</Item >
                <Item extra={itemscount} >题目</Item >
              </List >
